...
public class TotalPageItemCountFunctionTest extends TestCase
{
  ...
  private TableModel createRelationalTableModel()
  {
    ...
    model.addRow("RA", "r1", 1, 11, 11);
    model.addRow("RA", "r2", 2, 11, 11);
    model.addRow("RA", "r1", 1, 11, 11);
    model.addRow("RA", "r1", 1, 11, 11);
    model.addRow("RA", "r1", 2, 11, 11);
    model.addRow("RA", "r2", 1, 11, 11);
    model.addRow("RA", "r2", 1, 11, 11);
    model.addRow("RA", "r2", 2, 11, 11);
    model.addRow("RB", "r1", 1, 11, 11);
    model.addRow("RB", "r1", 1, 11, 11);
    model.addRow("RB", "r1", 1, 11, 11);
    model.addRow("RB", "r1", 2, 11, 11);
    model.addRow("RB", "r1", 1, 11, 11);
    model.addRow("RB", "r2", 2, 11, 11);
    model.addRow("RB", "r2", 1, 12, 12);
    model.addRow("RB", "r2", 1, 12, 12);
    model.addRow("RB", "r2", 1, 12, 12);
    model.addRow("RB", "r2", 2, 12, 12);
    model.addRow("RB", "r2", 2, 12, 12);
    model.addRow("RB", "r2", 2, 12, 12);
    return model;
  }
